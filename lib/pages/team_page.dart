                    ...
                    children: <Widget>[
                      ...
                      Container(
                        child: Row(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: <Widget>[
                      SizedBox(width:5),_buildFrameworkItem("JAVA"), SizedBox(width:10),    _buildFrameworkItem("C#"),
                            SizedBox(width:10),   _buildFrameworkItem("PHP"),
                            SizedBox(width:10),   _buildFrameworkItem("IA"),
                            SizedBox(width:10),  _buildFrameworkItem("C"),
                            SizedBox(width:10),  _buildFrameworkItem("Mobile"),
                          ],
                        ),
                      ),
                      SizedBox(height: 20),
                      ...
                      Container(
                        ...
                        // padding: const EdgeInsets.all(8.0),
                          ...
                          crossAxisAlignment: CrossAxisAlignment.start,
                              ...
                              SizedBox(width:5),   _buildFrameworkItem("Laravel"),
                      ...
                      Container(
                        ...
                        child: Row(
                            ...
                            children: <Widget>[
                              ...
                              SizedBox(width:5) ,_buildFrameworkItem("Merise"),
                              SizedBox(width:10),_buildFrameworkItem("Uml"),
                            ],
                      ...
                      Padding(
                        padding: EdgeInsets.only(
                            left: 10, right: 50, top: 0, bottom: 10),
                        child: _buildFrameworkItem("Arabe : Maternelle"),
                      ),
                      Padding(
                        padding: EdgeInsets.only(
                            left: 10, right: 50, top: 0, bottom: 10),
                        child: _buildFrameworkItem("Francais : Moyen"),
                      ),
                      Padding(
                        padding: EdgeInsets.only(
                            left: 10, right: 50, top: 0, bottom: 10),
                        child: _buildFrameworkItem("Anglais : Moyen"),
                      ),
                    ],

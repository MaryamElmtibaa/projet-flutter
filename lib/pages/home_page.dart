                  ...
                  child: Column(
                    children: [
                      ...
                      Padding(
                        ...
                        child: _itemWidgett("Date naissance: 25/12/1998",""),
                      ),
                      Padding(
                        padding: EdgeInsets.only(
                            left: 20, right: 10, top: 0, bottom:0),
                        child: _itemWidgett("Genie Informatique : IIT",""),
                      ),
                      Padding(
                        padding: EdgeInsets.only(
                            left: 20, right: 10, top: 0, bottom: 0),
                        child: _itemWidgett("Licence en Informatique de gestion : 2021 (FSEGS)",""),
                      ),
                      Padding(
                        padding: EdgeInsets.only(
                            left: 20, right: 0, top: 0, bottom: 0),
                        child: _itemWidgett("Bac Informatique : 2018",""),
                      ),
